...
using WinttOS.Base.Utils.Cryptography;
using static WinttOS.Base.Users.User;

namespace WinttOS.Base.Users
{
    public class User
    {
    ...
    public class TempUser
    {
        ...
        public AccessLevel? UserAccess { get; private set; } = null;
        ...
        public class TempUserBuilder
        {
            ...
            public TempUserBuilder SetAccess(AccessLevel UserAccess)
            {
